...
Value appendrawtransaction(const Array& params, bool fHelp)
{
	...
	//LogPrintf("[ITHONG] appendrawtransaction : new_outputs =%d \n", new_outputs);
 ...
 */  
	...
	//LogPrintf("[ITHONG] appendrawtransaction : sign_it=%d, lock_it=%d, send_it=%d \n", sign_it, lock_it,send_it);
...
Value createrawtransaction(const Array& params, bool fHelp)
{
	...
	//LogPrintf("[ITHONG] createrawtransaction : should not come here \n");
