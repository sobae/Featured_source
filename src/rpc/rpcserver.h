...
extern json_spirit::Value resetnetstat(const json_spirit::Array& params, bool fHelp);
#endif
...
#if 1//ithong_hmpl
extern json_spirit::Value pushhmpl(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value listhmpl(const json_spirit::Array& params, bool fHelp);
#endif
...
#if 1//ithong_stat
extern json_spirit::Value getblocklocal(const json_spirit::Array& params, bool fHelp);
#endif
