...
#ifndef _HDAC_PARAMLIST_H_
#define _HDAC_PARAMLIST_H_

static const mc_OneHdacParam HdacParamArray[] =
{
    { "chainprotocol"                          , "chain-protocol"                          ,
                   ...
                   "Chain protocol: hdac (permissions, native assets) or bitcoin"},
    ...
    */                   
    ...
    { "chainname"                              , "chain-name"                              ,
                   ...
                   "protocolversion","",
                   "Chain name, used as first argument for hdacd and hdac-cli."},  
